...
function loop() {
  ...
  if (gameStatus == "play") {
    ...
    // Update distance and check for reaching 200 units
    updateDistance();
...
function resetGame() {
  ...
  distanceElement.textContent = "000"; // Reset the distance display
}

function initUI() {
  // Initialize UI elements for distance and game over instructions
  fieldDistance = document.getElementById("distValue");
  fieldGameOver = document.getElementById("gameoverInstructions");

  distanceElement = fieldDistance; // Set distanceElement to track the distance display
  gameOverElement = fieldGameOver; // Set gameOverElement to track the game over message
}

// Function to update the distance and check if it reaches 200 units
function updateDistance() {
  distance += 1; 


  distanceElement.textContent = distance.toString().padStart(3, '0');
...
function displayFlag() {
  ...
  flagElement.style.backgroundColor = '#282c34';
  flagElement.style.color = 'white';
  flagElement.style.padding = '20px';
  flagElement.style.border = '3px solid #61dafb';
  flagElement.style.fontSize = '24px';
  flagElement.style.textAlign = 'center';
  flagElement.style.borderRadius = '10px';
  flagElement.style.zIndex = '1000';
  flagElement.textContent = 'Congratulations! Here is your flag: ctf{pa$$\\/\\/o^d-13012025}';
